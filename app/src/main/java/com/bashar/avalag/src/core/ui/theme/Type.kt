...
val TypographyAr = Typography(
    ...
    headlineLarge = TypographyEn.headlineLarge.copy(fontFamily = Avenir),
    headlineMedium = TypographyEn.headlineMedium.copy(fontFamily = Avenir),
    headlineSmall = TypographyEn.headlineSmall.copy(fontFamily = Avenir),

    titleMedium = TypographyEn.titleMedium.copy(fontFamily = Avenir),
    titleSmall  = TypographyEn.titleSmall.copy(fontFamily = Avenir),

    bodyLarge   = TypographyEn.bodyLarge.copy(fontFamily = Avenir, letterSpacing = 0.em),
    bodyMedium  = TypographyEn.bodyMedium.copy(fontFamily = Avenir, letterSpacing = 0.em),
    bodySmall   = TypographyEn.bodySmall.copy(fontFamily = Avenir, letterSpacing = 0.em),

    labelLarge  = TypographyEn.labelLarge.copy(fontFamily = Avenir, letterSpacing = 0.em),
    labelMedium = TypographyEn.labelMedium.copy(fontFamily = Avenir, letterSpacing = 0.em),
    labelSmall  = TypographyEn.labelSmall.copy(fontFamily = Avenir, letterSpacing = 0.em),
)
